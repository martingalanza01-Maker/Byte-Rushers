          ...
          <div className="flex items-center space-x-4">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                <DropdownMenuItem asChild>
                  <Link
                    href={user.type === "staff" ? "/staff/settings" : "/resident/settings"}
                    className="flex items-center space-x-2"
                  >
              ...
              <SheetContent side="right" className="w-80">
                ...
                <div className="mt-8 space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Link href={user.type === "staff" ? "/staff/profile" : "/resident/profile"}>
                      <Button variant="ghost" className="w-full justify-start text-left hover:bg-blue-50">
                        <User className="h-4 w-4 mr-3" />
                        Profile
                      </Button>
                    </Link>
                    <Link href={user.type === "staff" ? "/staff/settings" : "/resident/settings"}>
                      <Button variant="ghost" className="w-full justify-start text-left hover:bg-blue-50">
