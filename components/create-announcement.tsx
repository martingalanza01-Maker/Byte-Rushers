...
export function CreateAnnouncement({ user, onNavigate }: CreateAnnouncementProps) {
  ...
  const handlePublish = async () => {
    ...
    toast({
      ...
      description: "Your announcement has been published and residents will be notified.",
    })
                ...
                >
                  {isPublishing ? (
                    ...
                    <>
                      ...
                      {formData.isScheduled ? "Schedule" : "Publish Now"}
                    </>
                  )}
                </Button>
